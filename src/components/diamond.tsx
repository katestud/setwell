...
export const DiamondIcon: React.FC<DiamondIconProps> = ({ color, shading, width = 50, height = 50 }) => {
  const id = useId()
  ...
  return (
    ...
    >
      ...
      <rect x="83.8912" y="0.707092" width="123.403" height="118.398" transform="rotate(44.6346 83.8912 0.707092)" style={rectStyle} stroke={color} />
    </svg>
  )
}
